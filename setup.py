...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Zombie Road.py"
 
        #Name of program
        self.project_name = "Zombie Road"
 
        #Project url
        self.project_url = "https://github.com/CSC305/s19p1h"
 
        #Version of program
        self.project_version = "1.6"
 
        #License of the program
        self.license = "No License"
 
        #Auhor of program
        self.author_name = "John Sullivan et. al"
        self.author_email = "jfsullivan1@my.uri.edu"
        self.copyright = "Copyright (c) 2019 JS."
 
        #Description
        self.project_description = "Zombie Road Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = 'Sprites/zombie.ico'
 
        #Extra files/dirs copied to game
        self.extra_datas = ['Sounds','Fonts','Sprites']
